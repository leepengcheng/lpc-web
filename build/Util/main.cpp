...
cout<<"return [[$node parentNode] getAttribute name]"<<endl;
cout<<"} elseif {$key==\"name\"} {"<<endl;
cout<<"return [$node getAttribute name]"<<endl;
cout<<"}"<<endl;
cout<<"}"<<endl;
cout<<"}"<<endl;
...
cout<<"set stepsize [expr -$flag*$factor*$pwk/$height]"<<endl;
...
cout<<"-command [list [code handleLoadCase] \"WRITE\"]\\"<<endl;
...
cout<<"variable tabledata"<<endl;
cout<<"variable lclistbox"<<endl;
cout<<"if {$operator==\"WRITE\"} {"<<endl;
cout<<"if {[$lclistbox size]==0} {"<<endl;
cout<<"tk_messageBox -title [msgcat::mc \"Tips \"] \\"<<endl;
cout<<"-parent $parent\\"<<endl;
cout<<"-message [msgcat::mc \"No LoadCase Was Read! \"] \\"<<endl;
cout<<"-icon warning"<<endl;
cout<<"return"<<endl;
cout<<"}"<<endl;
cout<<"set lcfile [tk_getSaveFile  -filetypes {{loadcase .l*}}]"<<endl;
cout<<"set dirname [file dirname $lcfile]"<<endl;
cout<<"set filename [file tail $lcfile]"<<endl;
cout<<"set command \"LCWRITE,11,'$filename','','$dirname'\""<<endl;
cout<<"puts $command"<<endl;
...
cout<<"-command [code selectfile]\\"<<endl;
cout<<"-font $font(content) ]"<<endl;
...
cout<<"set stepsize [expr  -$flag*$height*$rw]"<<endl;
cout<<"}"<<endl;
cout<<"}"<<endl;
cout<<"proc getNodesAttachToArea {}\\"<<endl;
cout<<"{"<<endl;
...
cout<<"puts \"$cmd_sfcum\""<<endl;
cout<<"puts \"SFGRAD,PRES,0,$direction,$toploc,$factor*$stepsize\""<<endl;
cout<<"puts \"SF,ALL,PRES,0\""<<endl;
...
cout<<"set min_pressure [expr 0.5*$rw*$min_height*$min_height*$factor]"<<endl;
cout<<"set max_pressure [expr 0.5*$rw*$max_height*$max_height*$factor]"<<endl;
...
cout<<"set min_pressure [expr 0.5*$rw*$min_height*$min_height]"<<endl;
cout<<"set max_pressure [expr 0.5*$rw*$max_height*$max_height]"<<endl;
cout<<"set stepsize [expr ($max_pressure-$min_pressure)*1.0/$element_dis]"<<endl;
...
cout<<"}"<<endl;
cout<<"catch {ans_sendcommand \"ACEL,$g*$gravity,0,0\"}"<<endl;
