...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.vtkWidget.setGeometry(QtCore.QRect(0, 10, 511, 561))
        self.vtkWidget.setObjectName("vtkWidget")
        self.widget = QtWidgets.QWidget(self.centerWindow)
        self.widget.setGeometry(QtCore.QRect(520, 10, 381, 561))
        self.widget.setObjectName("widget")
        self.gridLayout = QtWidgets.QGridLayout(self.widget)
        self.gridLayout.setContentsMargins(10, 5, 10, 5)
        self.gridLayout.setObjectName("gridLayout")
        self.edit_center_x = QtWidgets.QLineEdit(self.widget)
        ...
        self.gridLayout.addWidget(self.label_angle, 11, 2, 1, 1)
        self.check_polarsys = QtWidgets.QCheckBox(self.widget)
        self.check_polarsys.setObjectName("check_polarsys")
        self.gridLayout.addWidget(self.check_polarsys, 11, 1, 1, 1)
        self.check_boundary = QtWidgets.QCheckBox(self.widget)
        self.check_boundary.setObjectName("check_boundary")
        self.gridLayout.addWidget(self.check_boundary, 4, 1, 1, 1)
        self.label_cdbfile = QtWidgets.QLabel(self.widget)
        self.label_cdbfile.setObjectName("label_cdbfile")
        self.gridLayout.addWidget(self.label_cdbfile, 0, 0, 1, 1)
        self.combo_patternmodel = QtWidgets.QComboBox(self.widget)
        ...
        self.edit_result = QtWidgets.QPlainTextEdit(self.widget)
        ...
        self.edit_center_z = QtWidgets.QLineEdit(self.widget)
        ...
        self.edit_ange = QtWidgets.QLineEdit(self.widget)
        self.edit_ange.setObjectName("edit_ange")
        self.gridLayout.addWidget(self.edit_ange, 11, 3, 1, 1)
        self.label_nodeinfo = QtWidgets.QLabel(self.widget)
        self.label_nodeinfo.setObjectName("label_nodeinfo")
        self.gridLayout.addWidget(self.label_nodeinfo, 13, 0, 1, 1)
        self.label_sys = QtWidgets.QLabel(self.widget)
        self.label_sys.setObjectName("label_sys")
        self.gridLayout.addWidget(self.label_sys, 5, 0, 1, 1)
        self.check_section = QtWidgets.QCheckBox(self.widget)
        self.check_section.setObjectName("check_section")
        self.gridLayout.addWidget(self.check_section, 5, 1, 1, 1)
        self.combo_patternboundary = QtWidgets.QComboBox(self.widget)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_angle.setText(_translate("mainWindow", "角度值"))
        self.check_polarsys.setText(_translate("mainWindow", "显示柱坐标系"))
        ...
        self.combo_patternmodel.setItemText(2, _translate("mainWindow", "云图模式"))
        ...
        self.btn_newsec.setText(_translate("mainWindow", "创建截面"))
        self.combo_result.setItemText(0, _translate("mainWindow", "Seqv"))
        self.combo_result.setItemText(1, _translate("mainWindow", "Usum"))
        self.combo_result.setItemText(2, _translate("mainWindow", "Sx"))
        self.combo_result.setItemText(3, _translate("mainWindow", "Sy"))
        self.combo_result.setItemText(4, _translate("mainWindow", "Sz"))
        self.combo_result.setItemText(5, _translate("mainWindow", "Sxy"))
        self.combo_result.setItemText(6, _translate("mainWindow", "Syz"))
        self.combo_result.setItemText(7, _translate("mainWindow", "Sxz"))
        self.combo_result.setItemText(8, _translate("mainWindow", "Ux"))
        self.combo_result.setItemText(9, _translate("mainWindow", "Uy"))
        self.combo_result.setItemText(10, _translate("mainWindow", "Uz"))
        ...
        self.combo_patternsection.setItemText(2, _translate("mainWindow", "云图模式"))
        ...
        self.label_nodeinfo.setText(_translate("mainWindow", "节点信息:"))
        ...
        self.combo_patternboundary.setItemText(2, _translate("mainWindow", "云图模式"))
